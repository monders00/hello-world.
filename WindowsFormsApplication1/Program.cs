...
//using static com.google.zxing.RGBLuminanceSource;
...
namespace QrCode
{
    class Program
    {
        ...
        static void btnFullScreen()
        {
            ...
            //保存
            image.Save(System.Environment.CurrentDirectory + "\\screen.jpeg", ImageFormat.Jpeg);
        }
        ...
        static void Main(string[] args)
        {
            ...
            //解析微博失败
            btnFullScreen();
            string filename = System.Environment.CurrentDirectory + "\\screen.jpeg";
            //string filename = @"H:\桌面\截图\qrcode1.png";
            //string filename = @"H:\桌面\截图\qrcode2.png";
            //string filename = @"H:\桌面\截图\qrcode3.png";
            string result = Read1(filename);
